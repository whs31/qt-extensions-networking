...
constexpr const array<u16, 256> CRC16_TABLE = {
...
namespace QtEx::NetworkUtils
{
  ...
  auto checksum(const char* data, int size, ChecksumMode mode) noexcept -> u16
  {
    switch(mode)
    {
      case ChecksumMode::CRC16CCIITT: {
      ...
      case ChecksumMode::CRC16: [[fallthrough]];
      default: {
        u16 crc = 0xFFFF;
  ...
  auto stringToChar(const QString& str) noexcept -> char* { return str.toLocal8Bit().data(); }
